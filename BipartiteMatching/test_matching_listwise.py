...
outputfile = "Rslt/Listwise_matching{}_index{}.csv".format(args.instance, args.index)
regretfile = "Rslt/Listwise_matchingRegret{}_index{}.csv".format(args.instance, args.index)
ckpt_dir =  "ckpt_dir/Listwise{}_index{}/".format(args.instance, args.index)
log_dir = "lightning_logs/Listwise{}_index{}/".format(args.instance, args.index)
learning_curve_datafile = "LearningCurve/Listwise{}_temp{}_growth{}_lr{}_batchsize{}_seed{}_index{}.csv".format(args.instance,temperature,growth, lr,batch_size,seed, args.index)
...
for seed in range(10):
    ...
    model = CachingPO(solver,loss= "listwise" ,growth=growth, init_cache=cache,tau=temperature,  lr=lr, seed= seed)
    ...
    model = CachingPO.load_from_checkpoint(best_model_path, solver=solver,loss= "listwise", growth=growth, init_cache=cache,tau=temperature, 
         lr=lr, seed= seed)    
