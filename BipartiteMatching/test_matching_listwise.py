...
learning_curve_datafile = "LearningCurve/Listwise{}_temp{}_lr{}_batchsize{}_seed{}_index{}.csv".format(args.instance,temperature,lr,batch_size,seed, args.index)
...
for seed in range(10):
    ...
    model = CachingPO(solver,loss= "listwise" ,init_cache=cache,tau=temperature,  lr=lr, seed= seed)
    ...
    model = CachingPO.load_from_checkpoint(best_model_path, solver=solver,loss= "listwise", init_cache=cache,tau=temperature, 
         lr=lr, seed= seed)    
