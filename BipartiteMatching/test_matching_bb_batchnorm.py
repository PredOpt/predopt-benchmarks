...
for seed in range(10):
    ...
    model = DBB(solver,lr=lr, lambda_val=lambda_val,mode="batchnorm",seed=seed)
    ...
    model = DBB.load_from_checkpoint(best_model_path ,solver=solver,lr=lr, lambda_val=lambda_val,mode="batchnorm",seed=seed)    
