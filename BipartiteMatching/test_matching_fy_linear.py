...
outputfile = "Rslt/FYLinear_matching{}_index{}.csv".format(args.instance, args.index)
regretfile = "Rslt/FYLinear_matchingRegret{}_index{}.csv".format(args.instance, args.index)
ckpt_dir =  "ckpt_dir/FYLinear{}_index{}/".format(args.instance, args.index)
log_dir = "lightning_logs/FYLinear{}_index{}/".format(args.instance, args.index)
learning_curve_datafile = "LearningCurve/FYLinear{}_sigma{}_nsamp{}_lr{}_batchsize{}_seed{}_index{}.csv".format(args.instance,sigma, num_samples,lr,batch_size,seed, args.index)
...
for seed in range(10):
    ...
    model = FenchelYoung(solver,sigma=sigma, num_samples=num_samples,mode ="linear", lr=lr,seed=seed)
    ...
    model = FenchelYoung.load_from_checkpoint(best_model_path ,solver=solver,sigma=sigma, num_samples=num_samples,mode ="linear", lr=lr,seed=seed)    
