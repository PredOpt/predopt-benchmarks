...
outputfile = "Rslt/SPOBatchnorm_matching{}_index{}.csv".format(args.instance, args.index)
regretfile = "Rslt/SPOBatchnorm_matchingRegret{}_index{}.csv".format(args.instance, args.index)
ckpt_dir =  "ckpt_dir/SPOBatchnorm{}_index{}/".format(args.instance, args.index)
log_dir = "lightning_logs/SPOBatchnorm{}_index{}/".format(args.instance, args.index)
learning_curve_datafile = "LearningCurve/SPOBatchnorm{}_lr{}_batchsize{}_seed{}_index{}.csv".format(args.instance,lr,batch_size,seed, args.index)
...
for seed in range(10):
    ...
    model = SPO(solver,lr=lr,mode ="batchnorm"  , seed=seed)
    ...
    model = SPO.load_from_checkpoint(best_model_path ,solver=solver,lr=lr,mode ="batchnorm" , seed=seed)    
