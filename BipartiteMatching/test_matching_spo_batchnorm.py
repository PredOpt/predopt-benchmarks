...
regretfile = "Rslt/SPOBatchnorm_matching{}_index{}Regret.csv".format(args.instance, args.index)
...
for seed in range(10):
    ...
    model = SPO.load_from_checkpoint(best_model_path ,solver=solver,lr=lr)    
