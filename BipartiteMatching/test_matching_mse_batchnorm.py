...
regretfile = "Rslt/MSEBatchnorm_matching{}_index{}Regret.csv".format(args.instance, args.index)
...
for seed in range(10):
    ...
    model = baseline_mse(solver,lr=lr, norm=True)
    ...
    model = baseline_mse.load_from_checkpoint(best_model_path ,solver=solver,lr=lr)    
