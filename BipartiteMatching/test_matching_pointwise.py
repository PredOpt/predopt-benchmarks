...
learning_curve_datafile = "LearningCurve/Pointwise{}_growth{}_lr{}_batchsize{}_seed{}_index{}.csv".format(args.instance,growth,lr,batch_size,seed, args.index)
...
for seed in range(10):
    ...
    model =  CachingPO(solver,loss= "pointwise",growth=growth,init_cache=cache,lr=lr, seed= seed)  
    ...
    loss= "pointwise",growth=growth,init_cache=cache,lr=lr, seed= seed)    
