...
outputfile = "Rslt/SPOLinear_matching{}_index{}.csv".format(args.instance, args.index)
regretfile = "Rslt/SPOLinear_matchingRegret{}_index{}.csv".format(args.instance, args.index)
ckpt_dir =  "ckpt_dir/SPOLinear{}_index{}/".format(args.instance, args.index)
log_dir = "lightning_logs/SPOLinear{}_index{}/".format(args.instance, args.index)
learning_curve_datafile = "LearningCurve/SPOLinear{}_lr{}_batchsize{}_seed{}_index{}.csv".format(args.instance,lr,batch_size,seed, args.index)
...
for seed in range(10):
    ...
    model = SPO(solver,lr=lr,mode='linear',seed=seed)
    ...
    model = SPO.load_from_checkpoint(best_model_path ,solver=solver,lr=lr,mode='linear',seed=seed)    
