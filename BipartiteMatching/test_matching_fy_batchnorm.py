...
outputfile = "Rslt/FYBatchnorm_matching{}_index{}.csv".format(args.instance, args.index)
regretfile = "Rslt/FYBatchnorm_matchingRegret{}_index{}.csv".format(args.instance, args.index)
ckpt_dir =  "ckpt_dir/FYBatchnorm{}_index{}/".format(args.instance, args.index)
log_dir = "lightning_logs/FYBatchnorm{}_index{}/".format(args.instance, args.index)
...
for seed in range(10):
    ...
    model = FenchelYoung(solver,sigma=sigma, num_samples=num_samples,mode ="batchnorm", lr=lr,seed=seed)
    ...
    model = FenchelYoung.load_from_checkpoint(best_model_path ,solver=solver,sigma=sigma, num_samples=num_samples,mode ="batchnorm", lr=lr,seed=seed)    
