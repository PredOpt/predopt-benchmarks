...
outputfile = "Rslt/MSE_matching{}_nlayer{}_index{}.csv".format(args.instance,n_layers, args.index)
regretfile = "Rslt/MSE_matchingRegret{}_nlayer{}_index{}.csv".format(args.instance,n_layers, args.index)
ckpt_dir =  "ckpt_dir/MSE{}_nlayer{}_index{}/".format(args.instance,n_layers, args.index)
log_dir = "lightning_logs/MSE{}_nlayer{}_index{}/".format(args.instance,n_layers, args.index)
learning_curve_datafile = "LearningCurve/MSE{}_lr{}_batchsize{}_seed{}_nlayer{}_index{}.csv".format(args.instance,lr,batch_size,seed, n_layers, args.index)
...
for seed in range(10):
    ...
    model = baseline_mse(solver,n_layers=n_layers, lr=lr,seed=seed)
    ...
    model = baseline_mse.load_from_checkpoint(best_model_path ,solver=solver, n_layers=n_layers, lr=lr,seed=seed)    
