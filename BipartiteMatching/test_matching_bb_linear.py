...
outputfile = "Rslt/DBBLinear_matching{}_index{}.csv".format(args.instance, args.index)
regretfile = "Rslt/DBBLinear_matchingRegret{}_index{}.csv".format(args.instance, args.index)
ckpt_dir =  "ckpt_dir/DBBLinear{}_index{}/".format(args.instance, args.index)
log_dir = "lightning_logs/DBBLinear{}_index{}/".format(args.instance, args.index)
learning_curve_datafile = "LearningCurve/DBBLinear{}_lambdaval{}_lr{}_batchsize{}_seed{}_index{}.csv".format(args.instance,lambda_val,lr,batch_size,seed, args.index)
