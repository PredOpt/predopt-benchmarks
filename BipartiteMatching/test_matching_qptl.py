...
import shutil
import random
from Trainer.PO_models import QPTL
import shutil
...
outputfile = "Rslt/QPTL_matching{}_index{}.csv".format(args.instance, args.index)
regretfile = "Rslt/QPTL_matchingRegret{}_index{}.csv".format(args.instance, args.index)
ckpt_dir =  "ckpt_dir/QPTL{}_index{}/".format(args.instance, args.index)
log_dir = "lightning_logs/QPTL{}_index{}/".format(args.instance, args.index)
learning_curve_datafile = "LearningCurve/QPTL{}_mu{}_lr{}_batchsize{}_seed{}_index{}.csv".format(args.instance,mu,lr,batch_size,seed, args.index)
...
for seed in range(10):
    ...
    model = QPTL(solver,lr=lr, mu=mu,seed=seed)
    ...
    model = QPTL.load_from_checkpoint(best_model_path ,solver=solver,lr=lr, mu=mu,seed=seed)    
