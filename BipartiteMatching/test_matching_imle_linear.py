...
outputfile = "Rslt/IMLELinear_matching{}_index{}.csv".format(args.instance, args.index)
regretfile = "Rslt/IMLELinear_matchingRegret{}_index{}.csv".format(args.instance, args.index)
ckpt_dir =  "ckpt_dir/IMLELinear{}_index{}/".format(args.instance, args.index)
log_dir = "lightning_logs/IMLELinear{}_index{}/".format(args.instance, args.index)
learning_curve_datafile = "LearningCurve/IMLELinear{}_inp{}_target{}_k{}_niter{}_lr{}_batchsize{}_seed{}_index{}.csv".format(args.instance,input_noise_temperature, target_noise_temperature ,
...
for seed in range(10):
    ...
    model = IMLE(solver,mode='linear',k=k, nb_iterations=nb_iterations, nb_samples=1,
    ...
    model = IMLE.load_from_checkpoint(best_model_path ,solver=solver,mode='linear',
