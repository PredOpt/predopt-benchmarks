...
learning_curve_datafile = "LearningCurve/IMLELinear{}_temp{}_beta{}_k{}_niter{}_lr{}_batchsize{}_seed{}_index{}.csv".format(args.instance,input_noise_temperature, beta ,
...
for seed in range(10):
    ...
    model = IMLE(solver,mode='linear',k=k, nb_iterations=nb_iterations, nb_samples= nb_samples,beta=beta,
