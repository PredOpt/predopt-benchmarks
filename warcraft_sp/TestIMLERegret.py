...
learning_curve_datafile = "LearningCurve/IMLERegret{}_tmp_{}beta_{}_lr{}_batchsize{}_numsamples{}_numiter{}_seed{}_index{}.csv".format(args.img_size,input_noise_temperature, beta,lr,batch_size,nb_samples,nb_iterations, seed,args.index)
