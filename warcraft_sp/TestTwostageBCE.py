...
outputfile = "Rslt/BaselineBCEHamming{}seed{}_index{}.csv".format(args.img_size,seed, args.index)
regretfile = "Rslt/BaselineBCEHammingRegret{}seed{}_index{}.csv".format(args.img_size,seed, args.index)
...
learning_curve_datafile = "LearningCurve/BaselineBCEHamming{}_lr{}_batchsize{}_seed{}_index{}.csv".format(args.img_size,lr,batch_size,seed,args.index)
