...
outputfile = "Rslt/DCOLRegret{}_index{}.csv".format(args.img_size, args.index)
ckpt_dir =  "ckpt_dir/DCOLRegret{}_index{}/".format(args.img_size, args.index)
log_dir = "lightning_logsDCOLRegret{}_index{}/".format(args.img_size, args.index)
