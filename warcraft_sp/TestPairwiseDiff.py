...
outputfile = "Rslt/Pairwisediff{}seed{}_index{}.csv".format(args.img_size,seed, args.index)
regretfile = "Rslt/PairwisediffRegret{}seed{}_index{}.csv".format(args.img_size,seed, args.index)
ckpt_dir =  "ckpt_dir/Pairwisediff{}seed{}_index{}/".format(args.img_size,seed, args.index)
log_dir = "lightning_logs/Pairwisediff{}seed{}_index{}/".format(args.img_size,seed, args.index)
