...
parser.add_argument("--tau", type=float, help="temperature parameter", default= 0.01, required=False)
...
model =  CachingPO(metadata=metadata,lr=lr, seed=seed,init_cache=cache, tau=tau,growth= growth,loss= "listwise")
