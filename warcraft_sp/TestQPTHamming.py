...
outputfile = "Rslt/QPTLHamming{}_index{}.csv".format(args.img_size, args.index)
ckpt_dir =  "ckpt_dir/QPTLHamming{}_index{}/".format(args.img_size, args.index)
log_dir = "lightning_logsQPTLHamming{}_index{}/".format(args.img_size, args.index)
