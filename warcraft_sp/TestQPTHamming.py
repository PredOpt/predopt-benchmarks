...
outputfile = "Rslt/QPTLHamming{}seed{}_index{}.csv".format(args.img_size,seed, args.index)
regretfile = "Rslt/QPTLHammingRegret{}seed{}_index{}.csv".format(args.img_size,seed, args.index)
ckpt_dir =  "ckpt_dir/QPTLHamming{}seed{}_index{}/".format(args.img_size,seed, args.index)
log_dir = "lightning_logs/QPTLHamming{}seed{}_index{}/".format(args.img_size,seed, args.index)
learning_curve_datafile = "LearningCurve/QPTLHamming{}_lr{}_mu{}_batchsize{}_seed{}_index{}.csv".format(args.img_size, lr, mu, batch_size,seed, args.index)
...
model =  QPTL(metadata=metadata, lr=lr, seed=seed,mu=mu, loss="hamming")
trainer.fit(model, datamodule=data)
best_model_path = checkpoint_callback.best_model_path
model = QPTL.load_from_checkpoint(best_model_path,
    metadata=metadata, lr=lr, seed=seed,mu=mu, loss="hamming")
