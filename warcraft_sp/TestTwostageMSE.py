...
regretfile = "Rslt/BaselineMSE{}seed{}_index{}.csv".format(args.img_size,seed, args.index)
...
model =  twostage_baseline(metadata=metadata, lr=lr, seed=seed,loss="mse")
trainer.fit(model, datamodule=data)
best_model_path = checkpoint_callback.best_model_path
model = twostage_baseline.load_from_checkpoint(best_model_path,
    metadata=metadata, lr=lr, seed=seed,loss="mse")
