...
learning_curve_datafile = "LearningCurve/BlackboxRegret{}_lambdaval_lr{}_batchsize{}_seed{}_index{}.csv".format(args.img_size, lambda_val,lr,batch_size,seed, args.index)
