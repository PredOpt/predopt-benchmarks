...
outputfile = "Rslt/SPO{}seed{}_index{}.csv".format(args.img_size,seed, args.index)
regretfile = "Rslt/SPORegret{}seed{}_index{}.csv".format(args.img_size,seed, args.index)
ckpt_dir =  "ckpt_dir/SPO{}seed{}_index{}/".format(args.img_size,seed, args.index)
log_dir = "lightning_logs/SPO{}seed{}_index{}/".format(args.img_size, seed, args.index)
