...
parser.add_argument("--thr", type=float, help="Threshodl Paraemeter", default= 5e-4, required=False)
parser.add_argument("--damping", type=float, help="Damping parameter", default= 5e-4, required=False)
...
model =  IntOpt(metadata=metadata, lr=lr, seed=seed,thr=thr, damping=damping, loss="hamming")
