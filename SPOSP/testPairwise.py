...
outputfile = "Rslt/Normed_Pairwise_rslt.csv"
regretfile= "Rslt/Normed_Pairwise_Regret.csv"
    ...
    for noise in [0.0,0.5]:
        for N in [100,1000]:
            ...
            for seed in range(10):
                ...
                model = CachingPO(init_cache=init_cache,loss_fn=pairwise_loss, net= normed_net, growth= growth,tau=margin,
                ...
                init_cache=init_cache,loss_fn=pairwise_loss, net= normed_net, growth= growth,tau=margin,lr= lr,l1_weight=l1_weight, seed=seed, )
            ...
            "val_mse": mses })
            df['model'] ='Pairwise'
            df.to_csv("LearningCurve/Normed_Pairwise_data_N_{}_noise_{}_deg_{}_growth{}_lr{}_margin{}.csv".format(N,noise,deg,growth,lr, margin))   