...
for deg in [1]:
    for noise in [0.0]:
        ...
        input_noise_temperature , target_noise_temperature, k = 2., 1.0, 10
        ######################################  Data Reading #########################################
        ...
        for seed in range(10):
            ...
            model = IMLE(net= normed_net,nb_iterations= nb_iterations,nb_samples= nb_samples, k=k,
            ...
            net= normed_net,nb_iterations= nb_iterations,nb_samples= nb_samples, k=k,
                    input_noise_temperature= input_noise_temperature, target_noise_temperature= target_noise_temperature, 
                    lr= lr,l1_weight=l1_weight, seed=seed, max_epochs= max_epochs)
        ...
        "val_mse": mses })
        df['model'] ='IMLE'
        df.to_csv("LearningCurve/Normed_IMLE_data_N_{}_noise_{}_deg_{}_lr{}_ipnoise{}_opnoise{}_k{}_iter{}_samp{}.csv".format(N,noise,deg,lr,input_noise_temperature,
        target_noise_temperature,k,nb_iterations,nb_samples))