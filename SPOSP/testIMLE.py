    ...
    for noise in [0.0,0.5]:
        for deg in [4,6,8,2,1]:
            for beta in [1,10,100,1000]:
                ...
                "val_mse": mses })
                df['model'] ='IMLE'
                df.to_csv("LearningCurve/Normed_IMLE_data_N_{}_noise_{}_deg_{}_lr{}_temp{}_beta{}_k{}_iter{}_samp{}.csv".format(N,noise,deg,lr,input_noise_temperature,
                beta,k,nb_iterations,nb_samples))