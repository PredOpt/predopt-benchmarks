...
outputfile = "Rslt/Normed_IMLE_rslt.csv"
regretfile= "Rslt/Normed_IMLE_Regret.csv"
ckpt_dir =  "ckpt_dir/IMLE/"
log_dir = "lightning_logs/IMLE/"
...
for noise in [0.0]:
    for deg in [2,4,6,8]:
        for input_noise_temperature in [1.]:
            ###################################### Hyperparams #########################################
            lr = 0.1
            l1_weight = 1e-5
            batchsize  = 128
            ...
            # input_noise_temperature , target_noise_temperature= 2., 1.0
            ...
            for seed in range(10):
                ...
                model = IMLE(net= normed_net,nb_iterations= nb_iterations,nb_samples= nb_samples, 
                ...
                net= normed_net,nb_iterations= nb_iterations,nb_samples= nb_samples, 
                        input_noise_temperature= input_noise_temperature, target_noise_temperature= target_noise_temperature, 
                        lr= lr,l1_weight=l1_weight, seed=seed, max_epochs= max_epochs)
            ...
            "val_mse": mses })
            df['model'] ='IMLE'
            df.to_csv("LearningCurve/Normed_IMLE_data_N_{}_noise_{}_deg_{}_lr{}_ipnoise{}_opnoise{}_iter{}_samp{}.csv".format(N,noise,deg,lr,input_noise_temperature,
            target_noise_temperature,nb_iterations,nb_samples))