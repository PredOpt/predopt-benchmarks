...
outputfile = "Rslt/NoNormed_Blackbox_rslt.csv"
regretfile= "Rslt/NoNormed_Blackbox_Regret.csv"
ckpt_dir =  "ckpt_dir/NoNormedBlackbox/"
log_dir = "lightning_logs/NoNormedBlackbox/"
...
for mu in [10,1]:
    for noise in [0.0,0.5]:
        for deg in [1,2,4,6,8]:
            ...
            "val_mse": mses })
            df['model'] ='Blackbox'
            df.to_csv("LearningCurve/NoNormed_Blackbox_data_N_{}_noise_{}_deg_{}_mu{}_lr{}.csv".format(N,noise,deg,mu,lr))        