...
outputfile = "Rslt/UnitNormed_Blackbox_rslt.csv"
regretfile= "Rslt/UnitNormed_Blackbox_Regret.csv"
ckpt_dir =  "ckpt_dir/UnitNormed_Blackbox/"
log_dir = "lightning_logs/UnitNormed_Blackbox/"
    ...
    for noise in [0.0,0.5]:
        for deg in [4,8,6,2,1]:
            ...
            for seed in range(10):
                ...
                model = Blackbox(net= net, mu=mu, lr= lr,l1_weight=l1_weight, seed=seed, max_epochs= max_epochs)
            ...
            "val_mse": mses })
            df['model'] ='Blackbox'
            df.to_csv("LearningCurve/UnitNormed_Blackbox_data_N_{}_noise_{}_deg_{}_mu{}_lr{}.csv".format(N,noise,deg,mu,lr))