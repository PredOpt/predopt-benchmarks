...
outputfile = "Rslt/UnitNormed_SPO_rslt.csv"
regretfile= "Rslt/UnitNormed_SPO_Regret.csv"
ckpt_dir =  "ckpt_dir/UnitNormedSPO/"
log_dir = "lightning_logs/UnitNormedSPO/"
...
for N in [100,1000]:
    for deg in [4,6,8,2,1]:
        for noise in [0.0,0.5]:
            ...
            "val_mse": mses })
            df['model'] ='SPO'
            df.to_csv("LearningCurve/UnitNormed_SPO_data_N_{}_noise_{}_deg_{}_lr{}.csv".format(N,noise,deg,lr))