...
outputfile = "Rslt/Normed_QPTL_rslt.csv"
regretfile= "Rslt/Normed_QPTL_Regret.csv"
ckpt_dir =  "ckpt_dir/QPTL/"
log_dir = "lightning_logs/QPTL/"
    ...
    for noise in [0.0,0.5]:
        for deg in [1,2,4,6,8]:
            ...
            for seed in range(10):
                ...
                model = QPTL(net= net,mu=mu, lr= lr,l1_weight=l1_weight, seed=seed, max_epochs= max_epochs)
                trainer.fit(model, datamodule=data)
                best_model_path = checkpoint_callback.best_model_path
                model = QPTL.load_from_checkpoint(best_model_path,
                net= net,mu=mu, lr= lr, l1_weight=l1_weight, seed=seed)
            ...
            "val_mse": mses })
            df['model'] ='QPTL'
            df.to_csv("LearningCurve/QPTL_data_N_{}_noise_{}_deg_{}_lr{}_mu{}.csv".format(N,noise,deg,lr,mu))