...
outputfile = "Rslt/NONormed_DPO_rslt.csv"
regretfile= "Rslt/NONormed_DPO_Regret.csv"
ckpt_dir =  "ckpt_dir/NONormedDPO/"
log_dir = "lightning_logs/NONormedDPO/"
...
for noise in [0.0,0.5]:
    for deg in [4,8,6,2,1]:
        for sigma in [1,0.5,2]:
            ...
            "val_mse": mses })
            df['model'] ='DPO'
            df.to_csv("LearningCurve/NONormed_DPO_data_N_{}_noise_{}_deg_{}_lr{}_sigma{}_numsamples{}.csv".format( N,noise,deg,lr, sigma, num_samples))