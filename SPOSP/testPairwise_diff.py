...
outputfile = "Rslt/Normed_Pairwisediff_rslt.csv"
regretfile= "Rslt/Normed_Pairwisediff_Regret.csv"
    ...
    for noise in [0.0,0.5]:
        for N in [100,1000]:
            ...
            for seed in range(10):
                ...
                model = CachingPO(init_cache=init_cache, loss_fn= pairwise_diffloss, net= normed_net, growth= growth,
                ...
                init_cache=init_cache,loss_fn=pairwise_diffloss, net= normed_net, growth= growth,lr= lr,l1_weight=l1_weight, seed=seed, )
                ...
                df ['model'] = 'Pairwise_diff(batchnorm)'
                df ['growth'] = growth
                df['seed'] = seed
            ...
            "val_mse": mses })
            df['model'] ='Pairwise_diff'
            df.to_csv("LearningCurve/Normed_Pairwise_diff_data_N_{}_noise_{}_deg_{}_growth{}_lr{}.csv".format(N,noise,deg,growth,lr))