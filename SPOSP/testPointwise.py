...
outputfile = "Rslt/Normed_Pointwise_rslt.csv"
regretfile= "Rslt/Normed_Pointwise_Regret.csv"
...
for deg in [1,2,4,6]:
    for noise in [0.0,0.5]:
        for N in [100,1000]:
            ...
            "val_mse": mses })
            df['model'] ='Pointwise'
            df.to_csv("LearningCurve/Pointwise_data_data_N_{}_noise_{}_deg_{}_growth{}_lr{}.csv".format(N,noise,deg,growth,lr))