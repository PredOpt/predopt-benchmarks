...
outputfile = "Rslt/NoNormed_Listwise_rslt.csv"
regretfile= "Rslt/NoNormed_Listwise_Regret.csv"
ckpt_dir =  "ckpt_dir/NoNormed_Listwise/"
log_dir = "lightning_logs/NoNormed_Listwise/"
...
for N in [100,1000]:
    for noise in [0.0,0.5]:
        for deg in [2,4,6,8,1]:
            ...
            "val_mse": mses })
            df['model'] ='Listwise'
            df.to_csv("LearningCurve/Normed_Listwise_data_N_{}_noise_{}_deg_{}_growth{}_lr{}_temp{}.csv".format(N,noise,deg,growth,lr, temperature))