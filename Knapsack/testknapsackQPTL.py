...
outputfile = "Rslt/QPTL_index{}.csv".format( args.index)
regretfile = "Rslt/QPTL_Regretindex{}.csv".format( args.index)
ckpt_dir =  "ckpt_dir/QPTL_index{}/".format( args.index)
log_dir = "lightning_logs/QPTL_index{}/".format( args.index)
learning_curve_datafile = "LearningCurve/QPTLcapa{}_mu{}_lr{}_batchsize{}_index{}.csv".format(capacity,mu,lr,batch_size, args.index)
...
for seed in range(10):
    ...
    model =  QPTL(weights,capacity,n_items,mu=mu, lr=lr, seed=seed)
