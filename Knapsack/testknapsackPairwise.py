...
outputfile = "Rslt/Pairwise_index{}.csv".format( args.index)
...
for seed in range(10):
    ...
    model =  CachingPO(weights,capacity,n_items,init_cache=cache,growth=growth, tau=margin, lr=lr, seed=seed, loss="pairwise")
    ...
    model = CachingPO.load_from_checkpoint(best_model_path,
        ...
        tau=margin, lr=lr, seed=seed, loss="pairwise")
    ##### SummaryWrite ######################
